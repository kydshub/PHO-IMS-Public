...
// The data passed from the ConsignmentTransfers page has these extra fields
...
const PrintConsignmentTransferHistoryPage: React.FC = () => {
        ...
        return (
            <PrintLayout title="Error: Report Data Not Found">
                <div className="flex flex-col items-center justify-center text-center no-print">
                    ...
                    <p className="mt-2 text-secondary-600">This page cannot be accessed directly. Please generate a report from the Consignment Transfers page first.</p>
                    <Link to="/consignment/transfers">
                        <Button className="mt-6">Go to Consignment Transfers Page</Button>
                    </Link>
                </div>
            </PrintLayout>
        );
    ...
    const ReportHeader = () => (
        <div className="text-center mb-8 pb-4 border-b-2 border-gray-800">
            ...
            <h2 className="text-2xl font-semibold text-gray-700 mt-1">Consignment Transfer History Report</h2>
    ...
    return (
        <PrintLayout title={`Consignment Transfer History Report - ${new Date().toLocaleDateString()}`}>
            <ReportHeader />
...
export default PrintConsignmentTransferHistoryPage;
