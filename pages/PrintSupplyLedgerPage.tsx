...
const PrintSupplyLedgerPage: React.FC = () => {
    ...
    useEffect(() => {
        if (itemMaster) {
            document.title = `Supply Ledger - ${itemMaster.name}`;
    ...
    if (!itemMaster || !ledgerEntries) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-secondary-100 p-4">
        ...
        <div className="mb-8 pb-4 border-b-2 border-gray-800">
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <h2 className="text-xl font-semibold text-gray-700 mt-1">Supply Ledger / Stock Card</h2>
                </div>
...
export default PrintSupplyLedgerPage;