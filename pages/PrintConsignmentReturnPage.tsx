...
const PrintConsignmentReturnPage: React.FC = () => {
        ...
        return (
            <PrintLayout title="Voucher Not Found">
                 <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="mt-2 text-secondary-600">This page may have been accessed directly. Please generate a voucher from the Consignment Returns page first.</p>
                    <Link to="/consignment/returns">
                        <Button className="mt-6">Go to Consignment Returns</Button>
                    </Link>
                </div>
            </PrintLayout>
        );
    ...
    return (
        <PrintLayout title={`Consignment Return Voucher - ${log.controlNumber}`}>
            {renderHeader("Consignment Return Voucher", log.controlNumber)}
...
export default PrintConsignmentReturnPage;