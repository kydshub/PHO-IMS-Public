...
interface EditDispenseLogModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export const EditDispenseLogModal: React.FC<EditDispenseLogModalProps> = ({ isOpen, onClose, onSave, log }) => {
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            title={`Edit Voucher: ${log.controlNumber}`}
            footer={
